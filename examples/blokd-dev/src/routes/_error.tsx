...
export default function ErrorPage(props: any) {
  ...
  return (
    <section class="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
      <div class="block-panel block-panel-strong p-8">
        <span class="badge badge-error">{status}</span>
        <h1 class="mt-4 text-5xl font-black">Something went wrong</h1>
        <p class="muted-copy mt-4 text-lg leading-8">The request could not be completed. Try again or return to the documentation.</p>
        <div class="mt-8">
